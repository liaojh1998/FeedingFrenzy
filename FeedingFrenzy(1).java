...
public class FeedingFrenzy extends JPanel implements KeyListener
{
	...
	{
		frame = new JFrame("Feeding Frenzy");
...
class playerFish extends FeedingFrenzy implements MouseListener, MouseMotionListener
{
	...
	private void setName(){
		...
		final ImageIcon fishIcon = new ImageIcon("FishIcon.png");		
    	name = JOptionPane.showInputDialog(input,"Fish name?", "Name your fishie!",JOptionPane.INFORMATION_MESSAGE);
    	if(name == null){
    		System.exit(0);
    	}
